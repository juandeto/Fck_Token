...
contract Fck is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 70000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Fck Cancer";
    ...
    uint256 private numTokensSellToAddToLiquidity = numTokensToSell * 10**6 * 10**9;
    uint public numTokensToSell = 5000000
   ...
   function setMarketingFeePercent(uint256 marketingFee) external onlyOwner() {
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
      ...
      function setNumTokensToSell(uint256 _numTokensToSell) external onlyOwner() {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tCharity, uint256 tMarketing) = _getRValues(tAmount, tFee, tLiquidity, tCharity, tMarketing, _getRate());
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        return (rAmount, rTransferAmount, rFee, rCharity, rMarketing);
    }
    ...
    function _takeMarketing(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
